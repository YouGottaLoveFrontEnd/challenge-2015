...
for (var i = 0; i < t.length; i++) {
	$(".title-frontend").append('<span class="letter">' + t[i] + '</span>' );
}

$(".letter").realshadow({type: 'text', opacity: 0.1, color: '177, 175, 171'});

// *********************************************************/
// *** Realshadow effect on items **************************/
// *********************************************************/

$(".item-pen").realshadow({type: 'drop', color: '0,0,0', length: 5, inverse: true});
$(".item-brush-white").realshadow({type: 'drop', color: '100,100,100', length: 5, inverse: true});
$(".item-mouse").realshadow({type: 'drop', color: '50,50,50', length: 5, inverse: true});
$(".item-css").realshadow({type: 'drop', color: '50,50,50', length: 5, inverse: true});
$(".item-html").realshadow({type: 'drop', length: 4});
$(".item-js").realshadow({type: 'drop', length: 5});
$(".item-drupal").realshadow({type: 'drop', length: 6});
$(".logo").realshadow({type: 'drop', length: 3});
$(".credit-box").realshadow({type: 'drop', length: 3});
...
// *********************************************************/
// *** Display the arrow scroll down hint after loading ****/
// *********************************************************/
...
// *********************************************************/
// *** Blur background Effect on mouse Movement ************/
// *********************************************************/
